...
class MyClock:
    def __init__(self, base_pntr, clock_r, cvns):
        ...
        self.h_pntr = Pointer(base_pntr, 3*clock_r//5, self.cvns, width=6, fill='blue')
        ...
        self.s_pntr = Pointer(base_pntr, clock_r-5, self.cvns, 60, super_pntr=self.m_pntr, fill='blue')
